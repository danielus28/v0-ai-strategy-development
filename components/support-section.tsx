...
const SUPPORT_CHANNELS = [
  {
    ...
    description: "Ayúdanos a financiar la infraestructura y la mantención del observatorio, libre de intereses corporativos. Con $300 MXN nos ayudas a pagar servicios web y el apoyo de profesionales.",
    ctaText: "Donar ahora",
  ...
  },
  {
    ...
    description: "Súmate como analista de datos, científico/a de datos, en marketing, comunicación, diseño o desarrollo. Déjanos tus datos en un formulario corto y te contactamos con los próximos pasos.",
    ctaText: "Postular como voluntario",
    ctaHref: "https://docs.google.com/forms/d/e/1FAIpQLScq2ty5lQfqjbfSiTHT7Dz9jeNpj4-I_cKZAqP3MKwdxS3Hwg/viewform",
    isPrimary: false,
  },
  {
    id: "difusion",
          ...
          {SUPPORT_CHANNELS.map((channel, i) => {
            ...
            return (
              <motion.div
                ...
                className={`relative flex flex-col justify-between p-8 rounded-xl border transition-all duration-300 group hover:-translate-y-1.5 hover:shadow-md ${channel.isPrimary
              ...
              >
                ...
                <div>
                  {/* Icono */}
                  <div className={`w-12 h-12 rounded-lg flex items-center justify-center mb-6 transition-colors ${channel.isPrimary ? "bg-accent/15 text-accent" : "bg-muted text-muted-foreground group-hover:bg-accent/10 group-hover:text-accent"
                    }`}>
                ...
                <Button
                  ...
                  className={`w-full font-medium gap-2 ${channel.isPrimary
